                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="w-100 d-flex flex-column text-start ps-4">
                                    ...
                                    <a type="button" href="{{route('food.show',$food->id)}}" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
    ...
    <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form action="{{route('bookingTable.store')}}" method="POST" >
                    {{-- @method("post") --}}
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating date" >
                                <input type="date" class="form-control datetimepicker-input" name="datetime" id="datetime" placeholder="Date & Time"/>
                    ...
                    @enderror
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Special Request" name="sp_request" id="message" style="height: 100px"></textarea>
                                <label for="message">Special Request</label>
                            </div>
                        </div>
                        <div class="container mt-1">
                            @if(Session::has('bookinTable'))
                            <p class="alert {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('bookinTable') }}</p>
                            @endif
                        </div>
                        <div class="col-12">
